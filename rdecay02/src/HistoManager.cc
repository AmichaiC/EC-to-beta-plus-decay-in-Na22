...
void HistoManager::Book()
{
    ...
    // Enable MT merging so all worker threads write into one output file
    ...
    id = analysis->CreateH1("H11", "Energy deposit (MeV) in the detector 1", nbins, vmin, vmax);
    analysis->SetH1Activation(id, true);

    id = analysis->CreateH1("H12", "Total energy (MeV) in target and detectors", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);

    id = analysis->CreateH1("H13", "Coincidence spectrum (MeV) between the target and detector 1", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);

    id = analysis->CreateH1("H14", "Anti-coincidence spectrum (MeV) in the target", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);

    id = analysis->CreateH1("H15", "Anti-coincidence spectrum (MeV) in the detector 1", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);
    ...
    id = analysis->CreateH1("H19", "Energy deposit (MeV) in the detector 2", nbins, vmin, vmax);
    analysis->SetH1Activation(id, true);

    id = analysis->CreateH1("H21", "Coincidence spectrum (MeV) between the target and detector 2", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);

    id = analysis->CreateH1("H22", "Anti-coincidence spectrum (MeV) in the detector 2", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);

    id = analysis->CreateH1("H23", "Coincidence spectrum (MeV) between target and detector 2", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);

    id = analysis->CreateH1("H24", "Anti-coincidence spectrum (MeV) in the target for detector 2", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);

    id = analysis->CreateH1("H25", "Anti-coincidence spectrum (MeV) in the detector 2", nbins, vmin, vmax);
    analysis->SetH1Activation(id, false);
